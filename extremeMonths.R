...
## SCRIPT to create extreme event layers (maximal extreme event)
...
# For each pixel, the median and its variability (Median Absolute Deviation, MAD) are assessed. The code then evaluates whether the value is higher than the median and its variability. This is evaluated for each month. The number of months being an extreme event per pixel is finally counted and saved as a raster layer. 

extremeMonths <- function(rasterstack){
